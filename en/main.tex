...
For the learning rate, we applied a strategy of initializing with a higher value, so the random weights were put in the direction of convergence within the first epochs. Then, this rate was gradually reduced after later epochs, allowing for more and more refined weights adjustments. Thus, in the experiment with the 20 selected signs, the total number of epochs was 200, adopting an initial learning rate of 0.01, which was decreased to the values of 0.001, 0.0001 and 0.00001 after the end of the epochs 50, 100 and 150, respectively.
