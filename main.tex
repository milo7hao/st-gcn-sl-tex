...
Com relação ao modelo CORE-SL, entende-se que a discussão apresentada na \refsect{sec:problema-investigacao} e os respectivos trabalhos de citados são suficientes para realização do projeto.
